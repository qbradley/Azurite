...
use crate::{
    i_cleaner::ICleaner, i_gc_extent_provider::IGCExtentProvider, storage_error::StorageError,
};
...
pub struct IExtentModel {
    ...
    pub path: String,
    pub size: u64,
    pub lastModifiedInMS: i64,
}

#[allow(non_snake_case)]
#[async_trait]
pub trait IExtentMetadataStore: IGCExtentProvider + ICleaner + Send + Sync {
