/// Mirrors TypeScript `src/blob/lease/ContainerReadLeaseValidator.ts`.
///
/// Fidelity: only acts when a non-empty leaseId was supplied.
...
pub struct ContainerReadLeaseValidator {
    pub leaseAccessConditions: Option<LeaseAccessConditions>,
}

impl ContainerReadLeaseValidator {
...
impl ILeaseValidator for ContainerReadLeaseValidator {
