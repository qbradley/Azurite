# Porting Record — `src/blob/generated/handlers/IAppendBlobHandler.ts`

## File info
- Source path: `src/blob/generated/handlers/IAppendBlobHandler.ts`
- Source lines: `20`
- Source type: `autorest-generated`
- Rust target (per `PORTING-ORDER.md`): `azurite-blob/src/generated/handlers/i_append_blob_handler.rs`
- Crate: `azurite-blob`
- Module: `generated::handlers::i_append_blob_handler`
- Phase: `5.14`
- Status: `analyzed`
...
- Declares 4 operation methods for one generated handler family. The method order and argument order match `handlerMappers.ts` exactly.
